...
--INDX.name = ''
ORDER BY TABLES.TABLE_NAME, COLUMNS.COLUMN_NAME, FK_REF.TABLE_NAME, FK_REF.COLUMN_NAME, PK.CONSTRAINT_NAME, FK.CONSTRAINT_NAME, UK.CONSTRAINT_NAME, INDX.name
