...
SELECT
	...
	obj.create_date,
	obj.modify_date,
	HAS_PERMS_BY_NAME(obj.name, 'OBJECT', 'VIEW DEFINITION') AS [VIEW],
	HAS_PERMS_BY_NAME(obj.name, 'OBJECT', 'ALTER') AS [ALTER],
	HAS_PERMS_BY_NAME(obj.name, 'OBJECT', 'EXECUTE') AS [EXECUTE]
